...
class FaceDetector:
    ...
    def draw_face_box(self, img, xywh, conf, landmarks):
        h, w, c = img.shape
    ...
    def detect(self, orgimg, img_size: int = 640, conf_thres: float = 0.3, iou_thres=0.5):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                for j in range(det.size()[0]):
                    ...
                    faces.append((xywh, conf, landmarks))
